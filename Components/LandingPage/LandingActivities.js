				...
				<div className="col-lg-12 text-center">
					<div className="tab-menu-area">
						<ul className="nav nav-lend mb-3" role="tablist">
							...
							<li className="nav-item" role="presentation">
								<button className="nav-link" id="my-bets-tab" data-bs-toggle="tab" data-bs-target="#my-bets" type="button" role="tab" aria-controls="my-bets" aria-selected="false" tabindex="-1">my bets</button>
							</li>
							<li className="nav-item" role="presentation">
								<button className="nav-link" id="jackpots-tab" data-bs-toggle="tab" data-bs-target="#jackpots" type="button" role="tab" aria-controls="jackpots" aria-selected="false" tabindex="-1">jackpots</button>
							</li>
						</ul>
					</div>
