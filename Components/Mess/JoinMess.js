                ...
                <div className="card-body">
                  ...
                  <form className="row g-3 needs-validation" novalidate>
                    ...
                    <div className="col-12">
                      <label for="yourUsername" className="form-label">Mess Joining Secrect Key</label>
                    ...
                    <div className="col-12">
                      <button onClick={handleSubmit} className="btn btn-primary w-100" type="submit">Join Mess</button>
                    </div>
                    <div className="col-12">
                      <p className="small mb-0">If you want to be a manager! <Link href="/create-mess">Create a new Mess</Link></p>
                    </div>
                  </form>
