...
export async function _createLottery(_maxLotterySize, packageType) {
    try {
        ...
        const packageTypeValue = packageTypeEnum[packageType];
      ...
      const tx =await LotteryWithSigner.createLottery(_maxLotterySize, packageTypeValue);
    } catch (error) {
