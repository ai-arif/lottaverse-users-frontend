...
async function _getLotteryDetails(_lotteryId) {
    try {
    ...
    const tx =await LotteryWithSigner.getLotteryDetails(_lotteryId);
  ...
  return <button onClick={() => _getLotteryDetails(_lotteryId)}>Get User Address</button>
} 