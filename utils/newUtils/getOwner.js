...
// },});
//
export async function _getOwner(walletProvider,isConnected) {
  try {
  ...
  const tx =await LotteryWithSigner.owner();
...
//     }
//   }
//   return <button onClick={() => _getOwner()}>Get User Address</button>
// }
