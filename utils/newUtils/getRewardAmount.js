...
// },});
export async function _getRewardAmount(_claimer, _lotteryID, walletProvider,isConnected) {
  try {
  ...
  const tx =await LotteryWithSigner.getRewardAmount(_claimer, _lotteryID);
...
//
// export function GetRewardAmount(_claimer, _lotteryID) {
//   const { address, chainId, isConnected } = useWeb3ModalAccount()
//   const { walletProvider } = useWeb3ModalProvider()
//   async function _getRewardAmount(_claimer, _lotteryID, walletProvider,isConnected) {
//     try {
...
//     }
//   }
//   return <button onClick={() => _getRewardAmount(_claimer, _lotteryID) }>Get User Address</button>
// }